...
# execute if entity @s[tag=pot,scores={gap_timer=0,Health=12..,saturation_difference=..-1}] unless entity @p[tag=xlib_target,distance=..3] run function quantum:sword/passive/gap
...
execute if score .difficulty difficulty matches 0 run return run function quantum:sword/combo/difficulty0
